...
import com.google.inject.persist.jpa.DynamicFinderTest;
import com.google.inject.persist.jpa.EnsureJpaCanTakeObjectsInPropertiesTest;
...
import com.google.inject.persist.jpa.EntityManagerTransactionScopeTest;
import com.google.inject.persist.jpa.JoiningLocalTransactionsTest;
import com.google.inject.persist.jpa.JpaPersistServiceTest;
import com.google.inject.persist.jpa.JpaWorkManagerTest;
import com.google.inject.persist.jpa.ManagedLocalNestedTransactionsTest;
...
import com.google.inject.persist.jpa.RequiresUnitOfWorkTest;
...
public class AllTests {
  ...
  public static Test suite() {
    ...
    suite.addTestSuite(DynamicFinderTest.class);
    suite.addTestSuite(EnsureJpaCanTakeObjectsInPropertiesTest.class);

    suite.addTestSuite(EntityManagerFactoryProvisionTest.class);
    suite.addTestSuite(EntityManagerTransactionScopeTest.class);
    ...
    suite.addTestSuite(JpaPersistServiceTest.class);

    suite.addTestSuite(JpaWorkManagerTest.class);

    suite.addTestSuite(ManagedLocalNestedTransactionsTest.class);
    ...
    suite.addTestSuite(RequiresUnitOfWorkTest.class);
